...
export function SettingsToggle({ label, description, enabled, onChange }: SettingsToggleProps) {
  return (
...
export function SettingsLink({ label, icon, iconBg, rightContent, showArrow = true, onClick }: SettingsLinkProps) {
  return (
    <button
      onClick={onClick}
