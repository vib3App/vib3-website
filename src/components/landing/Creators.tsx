...
export function Creators() {
  return (
    <section id="creators" className="py-24 px-6 bg-gradient-to-b from-transparent via-[#6366F1]/5 to-transparent">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#6366F1]/10 border border-[#6366F1]/20 rounded-full mb-6">
              <span className="text-[#6366F1] text-sm font-medium">For Creators</span>
            </div>
            ...
            <button className="mt-10 px-8 py-4 bg-gradient-to-r from-[#6366F1] to-[#14B8A6] rounded-xl font-semibold transition-all hover:shadow-lg hover:shadow-[#6366F1]/30">
              Start Earning Today
            </button>
          </div>
          ...
          <div className="relative">
            <div className="aspect-square max-w-md mx-auto bg-gradient-to-br from-[#1A1F2E] to-[#0A0E1A] rounded-3xl border border-white/5 p-8 relative overflow-hidden">
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#6366F1]/20 rounded-full blur-3xl" />
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#14B8A6]/20 rounded-full blur-3xl" />
