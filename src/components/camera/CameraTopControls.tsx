  ...
  return (
    <div className="absolute top-4 left-0 right-0 z-10 px-4">
      <div className="flex items-center justify-between">
        <button onClick={onClose} className="w-10 h-10 rounded-full bg-black/30 flex items-center justify-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={onFlipCamera} className="w-10 h-10 rounded-full bg-black/30 flex items-center justify-center">
