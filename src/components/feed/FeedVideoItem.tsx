...
function ActionButtons({
  ...
  return (
    <div className="absolute right-3 bottom-28 md:bottom-16 flex flex-col items-center gap-5 z-20">
      ...
      {/* Remix */}
      <Link href={`/remix/${video.id}`} onClick={(e) => e.stopPropagation()} className="flex flex-col items-center">
        <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
        </svg>
        <span className="text-white text-xs font-semibold mt-1">Remix</span>
      </Link>
