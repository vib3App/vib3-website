...
export function ActionButtons({
  ...
  return (
    <>
      ...
      {/* Fixed settings button - always visible, always same spot */}
      <button
        onClick={() => setIsSettingsOpen(true)}
        className="fixed bottom-4 right-4 z-50 p-2.5 bg-black/50 backdrop-blur-sm rounded-full text-white/70 hover:text-white hover:bg-black/70 transition shadow-lg"
