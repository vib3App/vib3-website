...
export function SideNav() {
  ...
  return (
    <>
      <aside className="hidden md:flex flex-col w-64 h-screen fixed left-0 top-0 bg-gradient-to-b from-neutral-900 to-stone-950 border-r border-amber-900/20 overflow-y-auto">
        {/* Logo - Clickable to refresh */}
        <div
          onClick={handleLogoClick}
          className="flex items-center gap-2 px-6 py-4 mb-2 cursor-pointer hover:opacity-80 transition-opacity"
        >
        ...
        <nav className="flex-1 px-3 space-y-1">
          ...
          <div className="px-3 py-1 text-xs text-white/30 uppercase tracking-wider">Create</div>
          ...
          <button
            ...
            className="flex items-center justify-between w-full px-3 py-2 rounded-xl text-white/70 hover:bg-white/5 hover:text-white transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 rounded-xl text-white/70 hover:bg-white/5 hover:text-white transition-all w-full"
          >
        ...
        <div className="p-3 border-t border-white/5">
          {isAuthenticated && user ? (
            <Link
              href="/profile"
              className="flex items-center gap-3 p-3 rounded-xl hover:bg-amber-900/20 transition-colors"
            >
            ...
            <Link
              href="/login"
              className="flex items-center justify-center gap-2 p-3 rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold hover:opacity-90 transition-opacity"
            >
              Log in
            </Link>
          )}
