...
/** Film grain / noise overlay. Strength 0 = off, 1 = heavy. */
export function GrainPanel({ strength, onStrengthChange }: GrainPanelProps) {
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-white font-medium">Film Grain</h3>
        {strength > 0 && (
          <button
