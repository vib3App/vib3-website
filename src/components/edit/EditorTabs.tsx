...
import type { EditMode } from '@/hooks/useVideoEditor';
...
const modes: { id: EditMode; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'stickers', label: 'Stickers', icon: <span className="text-lg leading-none">&#x1F600;</span> },
  {
    id: 'audio',
    label: 'Audio',
  ...
  },
  {
    id: 'masks',
    label: 'Masks',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4h16v16H4z" /><circle cx="12" cy="12" r="5" strokeWidth={2} /></svg>,
  },
  {
    id: 'captions',
    label: 'Captions',
  ...
  },
  {
    id: 'stabilize',
    label: 'Stabilize',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 0v4m0-4h4m-4 0H8" /></svg>,
  },
  {
    id: 'clipspeed',
    label: 'Clip Spd',
  ...
  },
  {
    id: 'music',
    label: 'Music',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z" /></svg>,
  },
  {
    id: 'voiceeffects',
    label: 'Voice FX',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 3l2 2-2 2" /></svg>,
  },
  {
    id: 'transitions3d',
    label: '3D Trans',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z" /></svg>,
  },
  {
    id: 'speedramp',
    label: 'Ramp',
  ...
  },
  {
    id: 'customfonts',
    label: 'Fonts',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h10M4 18h6" /><text x="18" y="18" fill="currentColor" fontSize="10" fontWeight="bold">A</text></svg>,
  },
  {
    id: 'textanim',
    label: 'Animate',
  ...
  },
  {
    id: 'textpath',
    label: 'Path',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 17c3.5-3.5 7-7 10.5-3.5S17 17 21 14" /></svg>,
  },
  {
    id: 'karaoke',
    label: 'Karaoke',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14 10h4M14 13h3" /></svg>,
  },
  {
    id: 'translate',
    label: 'Translate',
