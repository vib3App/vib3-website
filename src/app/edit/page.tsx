...
function EditContent() {
  ...
  const {
    ...
    giphyStickers, selectedFont, textAnimation, textAnimDuration, textStyle, handleUpdateGiphyStickerPosition, buildExtraEdits, resetAdjustments,
  } = ed;
    ...
    <div className="min-h-screen aurora-bg">
      ...
      <div className="flex-1 flex items-center justify-center bg-black relative overflow-hidden">
        ...
        <div className="absolute top-4 right-4 flex gap-2">
          ...
          <button
            onClick={() => { history.saveSnapshot(getCurrentSnapshot()); resetAdjustments(); setSelectedFilter(0); }}
            className="w-9 h-9 rounded-full flex items-center justify-center bg-black/50 text-white"
