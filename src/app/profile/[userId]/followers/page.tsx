...
export default function FollowersPage() {
  ...
  const loadFollowers = useCallback(async (pageNum: number, append = false) => {
    try {
      setLoading(true);
      const result = await userApi.getFollowers(userId, pageNum, 20);
      if (append) {
      ...
      <main className="pt-20 md:pt-16 pb-8 relative z-10">
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          {loading && users.length === 0 ? (
            ...
            <div className="text-center py-12 text-white/50">No followers found</div>
          ) : (
