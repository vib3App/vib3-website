...
export default function ConversationPage() {
  ...
  const handleVideoCall = () => {
    if (conv.participant?.userId && conv.conversation?.id) {
      call.startCall(conv.participant.userId, 'video', conv.conversation.id);
    }
  };

  const handleAudioCall = () => {
    if (conv.participant?.userId && conv.conversation?.id) {
      call.startCall(conv.participant.userId, 'audio', conv.conversation.id);
    }
  };
    ...
    <div className="min-h-screen aurora-bg flex flex-col">
      ...
      {call.activeCall && (
        <VideoCallModal
          ...
          isOutgoing={call.activeCall.callerId === conv.user?.id}
