    ...
    <div className="min-h-screen aurora-bg flex flex-col">
      ...
      <header className="sticky top-0 z-40 glass-heavy rounded-b-2xl border-b border-white/10">
        <div className="flex items-center gap-3 px-4 h-14">
          <button onClick={goBack} className="text-white/70 hover:text-white" aria-label="Go back">
      ...
      <div className="sticky bottom-0 glass-heavy border-t border-white/10 p-4">
        <div className="flex items-center gap-3">
          ...
          {newMessage.trim() ? (
            ...
            <button className="text-white/50 hover:text-white" aria-label="Record voice message">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
