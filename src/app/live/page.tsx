    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-white/50 text-sm">@{stream.username}</p>
        </div>
      </div>
    </Link>
  );
...
export default function LivePage() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setStreams([
        // Placeholder - no streams for now
      ]);
      setIsLoading(false);
    }, 500);
  }, []);
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-white/50 mb-8 max-w-md mx-auto">
                There are no live streams right now. Be the first to go live and connect with your audience!
              </p>
              <button
                onClick={handleGoLive}
          ...
          <section className="mt-12 pt-12 border-t border-white/5">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-[#1A1F2E] rounded-2xl">
                ...
                <h3 className="text-white font-medium mb-2">Connect in Real-Time</h3>
                <p className="text-white/50 text-sm">
                  Engage with your audience live through comments and reactions
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-[#1A1F2E] rounded-2xl">
                ...
                <p className="text-white/50 text-sm">
                  Receive virtual gifts from viewers and turn them into real earnings
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-[#1A1F2E] rounded-2xl">
                ...
                <h3 className="text-white font-medium mb-2">Grow Your Audience</h3>
                <p className="text-white/50 text-sm">
                  Get discovered by new followers through the live discovery feed
                </p>
              </div>
            </div>
          </section>
